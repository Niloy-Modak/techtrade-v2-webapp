export const products = [
  ...
  // 9 SSD
  {
    ...
    banner: "/products/phone/samsung-980pro-banner.jpg",
    images: [
      "/products/phone/samsung-980pro-1.jpg",
      "/products/phone/samsung-980pro-2.jpg",
      "/products/phone/samsung-980pro-3.jpg",
    ],
    category: "ssd",
    brand: "Samsung",
  ...
  // 11 Digital Camera
  {
    ...
    slug: "sony-zv-e10-24-2mp-4k-touchscreen-vlogging-digital-camera",
    key_features: [
  ...
  // 12 Motherboard
  {
    ...
    slug: "gigabyte-b650m-h-am5-micro-atx-motherboard",
    key_features: [
